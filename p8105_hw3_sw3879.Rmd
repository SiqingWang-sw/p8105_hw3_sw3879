...
This plot shows BRFSS data for all states from 2002 to 2010. The mean BRFSS in 2002 is `r brfss_excellent |> filter(year == "2002") |> mean(data_value, na.rm = TRUE)`, and in 2010 is `r brfss_excellent |> filter(year == "2010") |> mean(as.numeric(data_value), na.rm = TRUE)`. 
