...
From the clustered bar plot, we can see that there are missing data in
2006 for a few counties but data is complete for 2010. In most states,
the majority of the response is “very good”, with Bronx, Kings, and
Queens county as exceptions. Comparing between 2006 and 2010, there is
generally an increase in data value in the “very good” response.
